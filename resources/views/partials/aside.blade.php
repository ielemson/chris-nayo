<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
        ...
        <span class="brand-text font-weight-light">Chris Addy-Nayo</span>
    </a>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{route("key_initiatives.index")}}" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="{{route("key_initiatives.create")}}" class="nav-link">
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{route("key_focus_areas.index")}}" class="nav-link">
                            <i class="fas fa-image nav-icon"></i>
                            <p>View</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{route("key_focus_areas.create")}}" class="nav-link">
                            <i class="fas fa-lock nav-icon"></i>
                            <p>Create</p>
                            </a>
                        </li>
